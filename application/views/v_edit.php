      ...
      <div class="row">
		...
		<form action="<?php echo base_url('c_mahasiswa/editdata'); ?>" method="POST">
			<div class="modal-body">
				<div>
					<input type="hidden" value="<?php echo $a['id_mahasiswa']; ?>" name="id_mahasiswa"></input>
				</div>
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nomer_hp" class="form-control" type="number" placeholder="Nomor HP" value="<?php echo $a['nomer_hp']; ?>" required>
                        </div>
                    </div>
