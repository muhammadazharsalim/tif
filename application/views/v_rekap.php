...
<div class="modal fade" id="modal_sum" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
      ...
      <tbody>
        ...
        <!-- tutup modal banyak -->
          <!-- modal banyak mahasiswa -->
<div class="modal fade" id="modal_nomor" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
      ...
      <?php  $no = 1; foreach ($viewlog as $a ) {?>
      <tbody>
        <tr>
          <td><?php echo $no++; ?></td>
          <td><?php echo $a['nim']; ?></td>
          <td><?php echo $a['nama_mahasiswa']; ?></td>
          <td><?php echo $a['no_hp_lama']; ?></td>
          <td><?php echo $a['no_hp_baru']; ?></td>
          <td><?php echo $a['tgl_diubah']; ?></td>
        </tr>
        <?php  } ?>
      </tbody>
    </table>
